...
public class Acceso  implements java.io.Serializable {
    ...
    public String toString() {
        return "Acceso{" + "idAcceso=" + idAcceso + ", empresa=" + empresa + ", nombreAcceso=" + nombreAcceso + ", apellidoAcceso=" + apellidoAcceso + ", usuario=" + usuario + ", contrasena=" + contrasena + ", email=" + email + ", tipoAcceso=" + tipoAcceso + ", fechaRegistroAcceso=" + fechaRegistroAcceso + '}';
    }
